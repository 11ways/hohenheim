...
## Deploy 2026-09-05 (robbedoes): compact CMS lists and visible range labels
...
`zd_deploy target:robbedoes` with the same artifact used on all three hosts.
...
Preflight: `/root/hohenheim-preflight-20260905-114943/`. Database backup integrity
...
Rollback: `tools/deploy-host.sh --rollback robbedoes --preflight
/root/hohenheim-preflight-20260905-114943` (one command). The retained rollback jar
...
## Deploy 2026-09-05 (robbedoes): date/time filters with translated comparisons
...
Preflight: `/root/hohenheim-preflight-20260905-133058/`. Database integrity,
transfer SHA-256 and copied keyring comparison passed; 7 settings files
...
Rollback command: `tools/deploy-host.sh --rollback robbedoes --preflight /root/hohenheim-preflight-20260905-133058`.
