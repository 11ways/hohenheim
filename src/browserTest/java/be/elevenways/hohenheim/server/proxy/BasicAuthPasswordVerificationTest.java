...
class BasicAuthPasswordVerificationTest {
    ...
    void onlyArgon2HashesVerifyAndPlaintextStoredValuesAreRefused() {
        ...
        assertThat(SiteDispatcher.verifyBasicAuthPassword("s3cret", hash, "site"))
            .as("step 1: an argon2 hash verifies the matching password").isTrue();
        assertThat(SiteDispatcher.verifyBasicAuthPassword("wrong", hash, "site"))
        ...
        assertThat(SiteDispatcher.verifyBasicAuthPassword("s3cret", "s3cret", "site"))
            .as("step 2: a non-argon2 stored value is refused, never plaintext-compared")
            .isFalse();

        // 3. Absent credentials fail closed.
        assertThat(SiteDispatcher.verifyBasicAuthPassword("anything", null, "site"))
