...
public class InstanceModel extends Model {
    ...
    /**
     * THE live AUTHORED instances: not soft-deleted and not generated by a product tier.
     *
     * AIDEV-NOTE: the one spelling the /manage scope (TenantScopes.INSTANCES), the instance
     * API and the instance file API all read. A generated row is managed through its owning
     * record's surface only, so a lane that spelled the pair itself could drift into
     * addressing one.
     */
