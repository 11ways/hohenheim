...
public class M027_DropDeadColumns extends Migration {
    ...
    public void down(MigrationBuilder schema) {
        schema.alterTable("site_domains", table -> {
            ...
            table.addColumn("certificate_type", ColumnType.TEXT, col -> col.nullable(true));
        });
        schema.alterTable("certificates", table -> {
            table.addColumn("dns_provider", ColumnType.TEXT, col -> col.nullable(true));
            table.addColumn("dns_credentials", ColumnType.TEXT, col -> col.nullable(true));
            table.addColumn("acme_server", ColumnType.TEXT, col -> col.nullable(true));
