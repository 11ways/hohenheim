...
public class M004_CreateSiteDomains extends Migration {
    ...
    public void up(MigrationBuilder schema) {
        schema.createTable("site_domains", table -> {
            ...
            table.foreignId("certificate_id", "certificates");
            table.addColumn("certificate_type", ColumnType.STRING, col -> col.maxLength(20).defaultValue("letsencrypt"));
