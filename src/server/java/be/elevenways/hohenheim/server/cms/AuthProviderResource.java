...
public final class AuthProviderResource extends RowResource {
    ...
    @Override public @Nullable Microcopy recordLabel() { return Microcopy.of("singular").withFilter("scope", "auth_provider"); }
     ...
     */
    @Override public @Nullable Microcopy description() { return CmsSupport.navHint("auth_provider"); }
