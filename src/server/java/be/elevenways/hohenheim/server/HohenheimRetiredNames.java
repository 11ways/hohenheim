 ...
 * (or ZENIT__COMMS__*), and a transport chain left in the old file would silently stop being read.
 *
...
public final class HohenheimRetiredNames {
    ...
    /** The comms settings file and environment prefix this host loaded by hand. */
